...
```{r gratitude-summary-stats, eval=TRUE, include=FALSE, echo=FALSE}
...
```{r model-gratitude-by-type-and-author-and-project, eval = FALSE}

# do users tend to express appreciation and gratitude differently by group and content?
creators_v_commenters_gratitude_by_project = glmer(grateful_count ~ project * author_group * type +
                                          (1 | author_name),
                                        data=sentiment_frame,
                                        family=poisson)
...
```{r gratitude-predictors-time, eval = FALSE}
