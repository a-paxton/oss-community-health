...
```{r anova-model-emotion-by-type-author-project}
...
```{r anova-model-emotion-by-type-author-project-time}
...
```{r anova-gratitude-by-type-and-author-and-project}
...
```{r anova_gratitude-predictors-time, eval = TRUE}
