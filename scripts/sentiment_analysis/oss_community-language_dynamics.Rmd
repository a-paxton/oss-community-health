...
```{r plot_splines, eval=TRUE, include=FALSE, echo=FALSE}
...
``` {r silently-reload-functions, eval=TRUE, include=FALSE, echo=FALSE}
library(splines)
source("utils/ossc-libraries_and_functions.r")
```
...
```{r silently-display-significant-results, eval=TRUE, include=FALSE, echo=TRUE}
