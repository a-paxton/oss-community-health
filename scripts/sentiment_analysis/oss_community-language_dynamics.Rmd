...
# load data
tickets_frame = read.table('../../data/analysis_data/sentiment_frame_tickets-for_r.csv',
...
sentiment_frame = tickets_frame %>%
  ...
  select(project,
         ...
         contains('date'),
         contains('open_'),
         -contains('issue_author_'),
         issue_author_last_issue,
         issue_author_last_comment) %>%
  ...
  mutate_at(vars(contains('issue_author_')),
            as.logical) %>%
