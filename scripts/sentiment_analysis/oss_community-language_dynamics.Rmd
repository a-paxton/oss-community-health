...
```{r activity-stats, include=FALSE, echo=TRUE, eval=TRUE}
...
#### Model 1.1a: As a linear mixed-effects model
...
```{r print-model-emotion-by-type-and-author, eval=TRUE, include=FALSE, echo=TRUE}
...
As a result, we turn to the biostatistics approach of multiple pairwise 
*t*-tests (corrected for comparisons) to better understand the effects.

#### Model 1.1b: As a series of pairwise *t*-tests
...
Prepare for the Model 1.1b table later in the file.
...
```{r combine_tests_types_author_groups_interactions}


```

#### Model 1.1c : Do different kinds of user contributions differ in emotion by projects?
...
```{r model-emotion-by-type-and-author-and-project_clean_up}
coefficients_and_se = data.frame(
...
```{r plot-model-emotion-by-type-and-membership, echo=FALSE, include=FALSE, eval=TRUE}
...
```{r plot-model-emotion-by-type-and-membership-and-project, echo=FALSE, include=FALSE, eval=TRUE}
...
```{r model-emotion-by-type-author-project-time_clean_up}
coefficients_and_se = data.frame(
...
```{r automatically_generate_contrasts}
...
```{r plot-model-emotion-by-contribution-and-membership-aggregated, include=FALSE, echo=FALSE, eval=TRUE}
...
```{r plot-model-emotion-by-contribution-and-membership-and-time-by-project, include=FALSE, echo=FALSE, eval=TRUE}
...
```{r gratitude-summary-stats, eval=TRUE, include=FALSE, echo=TRUE}
...
```{r plot-gratitude-predictors-by-project, include=FALSE, echo=FALSE, eval=TRUE}
...
```{r plot-predicting-retention-aggregated, echo=FALSE, include=FALSE, eval=TRUE}
