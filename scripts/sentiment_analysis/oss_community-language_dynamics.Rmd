...
```{r plot-model-emotion-by-type-author-time, echo=FALSE, eval=TRUE}
...
```{r plot-gratitude-predictors, echo=FALSE, eval=TRUE}
...
```{r plot-predicting-retention, echo=FALSE, eval=TRUE}
