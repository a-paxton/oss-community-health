...
pvalues = pd.read_csv("results/models/model_2.2_final_pvalues.tsv", delim_whitespace=True)
outname = "results/latex/model_2_2.tex"
...
columns = [
    ...
    ("1W", "Variance sentiment score", ""),
    ("2W", "Variance sentiment score", "Issue"),
    ("2W", "Variance sentiment score", "PR"),
