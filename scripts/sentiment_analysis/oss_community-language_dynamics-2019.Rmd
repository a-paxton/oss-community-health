...
dir.create(file.path("results", "data"), showWarnings=FALSE)
write.table(sentiment_frame,
	    file="results/data/sentiment_frame_2019.tsv",
	    sep="\t")
```
...
ggsave(plot = sentiment_plot_aggregated,
       height = 4,
       width = 5,
       filename = '../../figures/sentiment_analysis/ossc-sentiment_membership_contribution-aggregated_2019.jpg')
...
ggsave(plot = sentiment_plot_aggregated,
       ...
       width = 5,
       dpi = 150,
       filename = '../../figures/sentiment_analysis/ossc-sentiment_membership_contribution-aggregated-knitr_2019.jpg')
...
ggsave(plot = sentiment_plot_by_project,
       height = 10,
       width = 4,
       filename = '../../figures/sentiment_analysis/ossc-sentiment_membership_contribution-by_project_2019.jpg')
...
ggsave(plot = sentiment_plot_by_project,
       ...
       width = 4,
       dpi = 150,
       filename = '../../figures/sentiment_analysis/ossc-sentiment_membership_contribution-by_project-knitr_2019.jpg')
...
ggsave(plot = grateful_plot,
       height = 5,
       width = 6,
       filename = '../../figures/sentiment_analysis/ossc-grateful_membership_contribution_2019.jpg')
...
ggsave(plot = grateful_plot,
       ...
       width = 6,
       dpi = 150,
       filename = '../../figures/sentiment_analysis/ossc-grateful_membership_contribution-knitr_2019.jpg')
...
```{r predicting-retention-print, echo=FALSE}

# print it
pander(summary(retention_predictors))
...
ggsave(plot = retention_plot_aggregated,
       height = 5,
       width = 6,
       filename = '../../figures/sentiment_analysis/ossc-retention_emotion-aggregated_2019.jpg')
...
ggsave(plot = retention_plot_aggregated,
       ...
       width = 6,
       dpi = 150,
       filename = '../../figures/sentiment_analysis/ossc-retention_emotion-aggregated-knitr_2019.jpg')
...
ggsave(plot = retention_plot_by_project,
       height = 10,
       width = 6,
       filename = '../../figures/sentiment_analysis/ossc-retention_emotion-by_project_2019.jpg')
...
ggsave(plot = retention_plot_by_project,
       ...
       width = 6,
       dpi = 150,
       filename = '../../figures/sentiment_analysis/ossc-retention_emotion-by_project-knitr_2019.jpg')
